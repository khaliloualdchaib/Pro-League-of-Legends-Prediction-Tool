...
def players_and_teams(df):
    ...
    players_columns  = ['gameid', 'side', 'position', 'playername', 'playerid', 'teamname', 'teamid', 'champion', 'result', 'kills', 'deaths', 'killsat10', 'deathsat10','killsat15', 'deathsat15', 'assists', 'assistsat15', 'assistsat10', 'firstblood', 'firstbloodkill', 'firstbloodvictim','golddiffat10', "golddiffat15",'earned gpm', "teamkills"]
